...
function buildAuthSlice(set: SetState, get: GetState): AuthState {
  return {
    user: null,
...
// Default export: uses localStorage (web)
export const useAuthStore = create<AuthState>()(
  persist(
    (set, get) => buildAuthSlice(set, get),
    { name: "auth-storage" }
  )
);

// Factory for custom storage (React Native, etc.)
